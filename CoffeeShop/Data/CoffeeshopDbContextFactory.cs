...
namespace CoffeeShop.Data
{
    public class CoffeeshopDbContextFactory : IDesignTimeDbContextFactory<CoffeeshopDbContext>
    {
        public CoffeeshopDbContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseSqlServer("Server=ASUS_VIVOBOOK;Database=Bao_CoffeeShopDB;User Id=sa;Password=i990c,b7;Encrypt=False;TrustServerCertificate=True;Pooling=True;");
